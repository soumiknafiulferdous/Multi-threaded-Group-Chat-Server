...
A chatting system is implemented where multiple clients can join the server and chat together like in a chat-group. It is just like the facebook messenger group.
