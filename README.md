...
A chatting system is implemented where multiple clients can join the server and chat together like a chat-group. All the clients will be notified when a new client joins or leaves the server. It is just like the facebook messenger group.
